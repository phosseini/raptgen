...
@click.option("--reg-epochs", help="the number of epochs to conduct state transition regularization", type=int,
              default=50)
@click.option("--embed-size", help="the number of embedding dimension of raptgen model", type=int, default=2)
@click.option("--fast/--normal",
...
def main(seqpath, epochs, threshold, cuda_id, use_cuda, save_dir, fwd, rev, min_count, multi, reg_epochs, embed_size,
         fast):
